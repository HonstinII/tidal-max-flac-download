...
const els = {
  ...
  saveCoverFile: document.querySelector("#saveCoverFile"),
  ...
  coverFileStrategy: document.querySelector("#coverFileStrategy"),
...
const copy = {
  en: {
    ...
    coverFileStrategy: "Existing cover.jpg",
    strategySkip: "Skip",
    ...
    coverStrategySkipDetail: "Keep the existing cover.jpg in that folder.",
    coverStrategyOverwriteDetail: "Replace cover.jpg with the current Tidal cover.",
  ...
  zh: {
    ...
    coverFileStrategy: "已有 cover.jpg",
    strategySkip: "跳过",
    ...
    coverStrategySkipDetail: "保留该目录里已有的 cover.jpg。",
    coverStrategyOverwriteDetail: "用当前 Tidal 封面替换 cover.jpg。",
...
function queuePayload(urls) {
  return {
    ...
    save_cover_file: els.saveCoverFile.checked,
    cover_file_strategy: els.coverFileStrategy.value,
